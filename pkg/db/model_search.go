...
func (us *UserSearch) Apply(query *orm.Query) *orm.Query {
	...
	if us.StatusIDEQuals != nil {
		Filter{Columns.User.StatusID, *us.StatusIDEQuals, SearchTypeEquals, false}.Apply(query)
	}
...
func (ns *NewsSearch) Apply(query *orm.Query) *orm.Query {
	...
	if ns.StatusIDEQuals != nil {
		Filter{Columns.News.StatusID, *ns.StatusIDEQuals, SearchTypeEquals, false}.Apply(query)
	}
